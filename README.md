# 开放世界大逃杀 | Openworld BattleRoyale

[中文](#开放自定义大逃杀) | [English](#openworld-battleroyale)
...
Core Features:
- Randomly Generated Open World: Out-of-the-box vanilla terrain generation, with unique cover distribution and loot points across different biomes
...
This modpack builds upon a fully customizable Battle Royale experience by integrating vanilla terrain generation, eliminating concerns about finding suitable game maps.
...
### World Generation
Enriches the open world with more structures.
...
### Data Packs
Balances cover and loot density within the world.
